      ...
      {profile && (
        <div className="flex justify-between gap-10 items-center">
          ...
          <div className="w-6/12 bg-white  px-10 py-5 flex rounded-[20px] flex-col">
            <img src="img/worldcoin.png" className="mx-auto w-80 h-10 object-cover" />
            <h1 className="text-black text-center text-lg">Proove your uniqueness and humaness. <br></br>Verify your account using World ID</h1>
            <Button className="w-fit mx-auto bg-black hover:opacity-90 hover:bg-black transition">Verify</Button>
          </div>
        </div>
      )}
