	...
	return (
		<div className="w-64      rounded flex flex-col p-10 items-center justify-end">
			<Image
				...
				alt={platform.name}
			/>
			<h1 className="font-bold mt-3 text-xl text-white">
				{platform.name}
			</h1>
			<button
				onClick={() => {
	...
	return (
		<div>
			...
			<p className="text-center text-white w-8/12 mx-auto">
				...
				eligendi adipisci obcaecati quod dolor nihil ipsam dignissimos
				quasi, quia pariatur. Eligendi, quaerat eveniet rem voluptas
				reiciendis maiores? Quis, molestias iste?
			</p>
		</div>
	);
};
